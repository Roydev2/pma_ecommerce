                ...
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            ...
                            <h1 class="section-title white-color">Nous contacter</h1>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__form-box contact-form-box box-shadow white-bg">
                        <h3>Envoyer nous un message @auth @else<span style="font-size:12px;" class="text-danger">[Vous devez d'abord être connecter]</span>@endauth</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-item">
                                        <input name="subject" type="text" id="subject" placeholder="Entrer le sujet">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-item input-item-email ltn__custom-icon">
                                        <input name="email" type="email" id="email" placeholder="Entrer email">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-item input-item-phone ltn__custom-icon">
                                        <input id="phone" name="phone" type="text" placeholder="Entrer votre téléphone">
                                    </div>
                                </div>
                            </div>
                            <div class="input-item input-item-textarea ltn__custom-icon">
                                <textarea name="message" id="message" placeholder="Entrer le Message"></textarea>
                            </div>
