...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Ajouter catégorie</a>
    </div>
    <div class="card-body">
            ...
            @foreach($categories as $category)
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        @if($category->photo)
                            <img src="{{ URL::to('/assets/images/'.$category->photo)}}" class="img-fluid" style="max-width:80px" alt="{{$category->photo}}">
                        @else
