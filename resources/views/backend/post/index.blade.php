...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Liste des poste</h6>
      <a href="{{route('post.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Ajouter poste</a>
    </div>
    <div class="card-body">
            ...
            @foreach($posts as $post)
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        @if($post->photo)
                            <img src="{{asset('assets/images/post/'.$post->photo)}}" class="img-fluid zoom" style="max-width:80px" alt="{{$post->photo}}">
                        @else
