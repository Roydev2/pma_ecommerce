...
@section('main-content')
    <div class="card">
        <h5 class="card-header">Modifier poste</h5>
        <div class="card-body">
            <form method="post" action="{{ route('post.update', $post->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <img width="150" height="150" src="{{asset('assets/images/post/'.$post->photo)}}" alt="">
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="hidden" name="image_hidden" value="{{ $post->photo }}">
                    </div>
