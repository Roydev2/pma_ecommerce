...
@section('main-content')
    ...
    <div class="card">
        <h5 class="card-header">Modifier un carousel</h5>
        <div class="card-body">
            <form method="post" action="{{ route('banner.update', $banner->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <img width="250" height="150" src="{{asset('assets/images/banner/'.$banner->photo)}}" alt="">
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="hidden" name="image_hidden" value="{{ $banner->photo }}">
                    </div>
